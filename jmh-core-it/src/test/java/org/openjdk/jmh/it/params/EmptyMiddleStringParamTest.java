...
@Fork(1)
@State(Scope.Thread)
public class EmptyMiddleStringParamTest {
    ...
    public void test_ann() throws RunnerException {
        ...
        Assert.assertEquals(3, actualP.size());
        Assert.assertTrue(actualP.contains("val1"));
        Assert.assertTrue(actualP.contains("val2"));
