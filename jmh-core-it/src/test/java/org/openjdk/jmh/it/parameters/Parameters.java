...
public class Parameters {
    ...
    public static BenchmarkListEntry get(Class<?> klass) {
        ...
        Set<BenchmarkListEntry> set = list.find(OutputFormatFactory.createFormatInstance(System.out, VerboseMode.EXTRA), ".*" + klass.getName().replaceAll("\\$",".") + ".*", Collections.<String>emptyList());
